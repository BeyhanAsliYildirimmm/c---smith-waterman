...
namespace alignment
{
    ...
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i <= path1Chars.Length; i++)
            {
                for (int k = 0; k <= path2Chars.Length; k++)
                {
                    ...
                    else if (i == 0 && k > 0)
                    {
                        ...
                        {
                            values[i, k] = 0;
                            dataGridView1.Rows[i].Cells[k].Value = 0;
            ...
            {
                for (int m = 0; m < values.GetLength(1); m++)
                {
                    if (values[l, m] >= 1)
                    {
                           enbuyuk = values[l, m];
                            ...
                            if (dataGridView1.Rows[l].Cells[m].Value.ToString() == values[l, m].ToString())
                            {
                            
                                renk.BackColor = Color.Green;
                            
                            }
                           dataGridView1.Rows[l].Cells[m].Style = renk;
        ...
        private void MatchValue_TextChanged(object sender, EventArgs e)
        {
